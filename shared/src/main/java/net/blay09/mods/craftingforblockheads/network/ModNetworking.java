...
public class ModNetworking {
    ...
    public static void initialize(BalmNetworking networking) {
        ...
        networking.registerClientboundPacket(id("item_list"), CraftablesListMessage.class, CraftablesListMessage::encode, CraftablesListMessage::decode, CraftablesListMessage::handle);
